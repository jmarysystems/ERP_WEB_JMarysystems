...
public class DAOGenericoJPA<Gene> {
    ...
    public DAOGenericoJPA( Gene gene2, EntityManager em2 ) { try{
        ...
        } catch( Exception e ){ System.out.println( "DAOGenericoJPA( Gene gene2 ), \n" + e.getMessage() + "\n" + "DAOGenericoJPA<Gene>" ); }
    }
    ...
    public void inserir() { try {                   
        ...
        } catch( Exception e ){ System.out.println( "inserir(), \n" + e.getMessage() + "\n" + "DAOGenericoJPA<Gene>" ); }
    }
    
    public void excluir(){ try { Thread.sleep( 1 );                   
        ...
        } catch( Exception e ){ System.out.println( "excluir, \n" + e.getMessage() + "\n" + "DAOGenericoJPA<Gene>" ); }
    }
    ...
    public void atualizar(){ /*new Thread() {   @Override public void run() {*/ try { Thread.sleep( 1 );                   
        ...
        } catch( Exception e ){ System.out.println( "atualizar(), \n" + e.getMessage() + "\n" + "DAOGenericoJPA<Gene>" ); }
    }

    public void gravanovoOUatualizar(){ try { Thread.sleep( 1 );                   
        ...
        } catch( Exception e ){ System.out.println( "gravanovoOUatualizar(), \n" + e.getMessage() + "\n" + "DAOGenericoJPA<Gene>" ); }
    }
